...
//
// **Byte-for-byte the same helper as `FeatureCycleTests/WaitUntil.swift`, on purpose.** A test
...
// ViewModel carries this file (iOS-M6 divergence (j), restated for M7 as divergence (j)).
