...
//
// The Kotlin class is `internal` because Koin builds it behind the interface, and so is this one:
// `makeProfileRepository` in `ProfileModule.swift` is what callers outside the module get, exactly
...
final class ProfileRepositoryImpl: ProfileRepository {
    ...
    init(profileDao: ProfileDao, clock: any SalusClock) {
